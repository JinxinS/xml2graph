...
class XMLDLLENTRY ToXMLStringTool
{
public:
...
class XMLDLLENTRY XMLParserBase64Tool
{
public:
...
private:
    ...
    XMLParserBase64Tool(const XMLParserBase64Tool&);
    XMLParserBase64Tool& operator=(const XMLParserBase64Tool&);
};
/** @} */
